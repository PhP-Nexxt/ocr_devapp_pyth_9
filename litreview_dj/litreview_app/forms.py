...
class SignupForm(
    UserCreationForm
):  # Ici on importe le formulaire de creation de compte
    class Meta(
        UserCreationForm.Meta
    ):  # Les modifications sur les champ se font ici et pas sur l'Html
...
class ReviewForm(
    forms.ModelForm
):  # Formulaire de creation de Critique pas en reponse a un ticket (en cours)
