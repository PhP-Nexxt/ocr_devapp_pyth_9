"""
Django settings for ocr_project_9 project.
...
SECRET_KEY = "django-insecure-p@(^lm^5p_vb-5mg##^rste+p+3obrz4yam+56%r=%^#gs*xp+"
...
WSGI_APPLICATION = "ocr_project_9.wsgi.application"
